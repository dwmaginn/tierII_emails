...
from tests.fixtures import (
    get_david_config, apply_david_config, clear_david_config,
    get_luke_config, apply_luke_config, clear_luke_config
)
...
class TestLukeGmailWorkflow:
    ...
    def test_luke_config_loading(self):
        ...
        # Verify core email settings
        assert settings.sender_email == "luke@aiautocoach.com"
        ...
        assert settings.gmail_username == "luke@aiautocoach.com"
...
class TestConfigurationIsolation:
    ...
    def test_config_isolation_david_to_luke(self):
        ...
        assert "luke@aiautocoach.com" == luke_settings.sender_email
