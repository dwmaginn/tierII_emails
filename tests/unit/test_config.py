...
def test_missing_required_variables():
    ...
    env_vars = [
        'TIERII_SENDER_EMAIL', 'TIERII_SMTP_SERVER', 'TIERII_TENANT_ID',
        'TIERII_CLIENT_ID', 'TIERII_CLIENT_SECRET', 'TIERII_EMAIL_SUBJECT'
    ]
    ...
    try:
        ...
        try:
            ...
            print(f"✓ Correctly handled missing required variables with validation error: {type(e).__name__}")
    finally:
...
def test_minimal_configuration():
    ...
    test_env = {
        ...
        'TIERII_TENANT_ID': 'test-tenant-id',
        'TIERII_CLIENT_ID': 'test-client-id',
