...
class TestSendInBulk:
    ...
    @patch('os.getenv')
    def test_send_in_bulk_successful_campaign(self, mock_getenv, mock_load_config, mock_parse_contacts, 
    ...
    @patch('src.main.load_email_config')
    @patch('os.getenv')
    def test_send_in_bulk_failed_emails(self, mock_getenv, mock_load_config, mock_parse_contacts, 
                                       mock_mailersend, mock_email_builder, mock_logger, mock_tqdm,
                                       mock_sleep, mock_log_failed, mock_log_successful, mock_generate_report):
    ...
    @patch('src.main.load_email_config')
    @patch('os.getenv')
    def test_send_in_bulk_exception_handling(self, mock_getenv, mock_load_config, mock_parse_contacts, 
                                           mock_mailersend, mock_email_builder, mock_logger, mock_tqdm,
                                           mock_sleep, mock_log_failed, mock_log_successful, mock_generate_report):
    ...
    @patch('src.main.load_email_config')
    @patch('os.getenv')
    def test_send_in_bulk_empty_contacts(self, mock_getenv, mock_load_config, mock_parse_contacts, 
                                        mock_mailersend, mock_email_builder, mock_logger, mock_tqdm,
                                        mock_sleep, mock_log_failed, mock_log_successful, mock_generate_report):
    ...
    @patch('src.main.load_email_config')
    @patch('os.getenv')
    def test_send_in_bulk_success_rate_calculation(self, mock_getenv, mock_load_config, mock_parse_contacts, 
                                                  mock_mailersend, mock_email_builder, mock_logger, mock_tqdm,
                                                  mock_sleep, mock_log_failed, mock_log_successful, mock_generate_report):
